package ProjectDemo.demo.JwtConfig;
...
//                        .requestMatchers("/api/user").hasAuthority("USER")
    ...
    public AuthenticationProvider authenticationProvider(){ //chịu trách nhiệm cho 1 loại authentication
        ...
        authenticationProvider.setUserDetailsService(userService.userDetailsService()); //userDetailsService :interface của Spring Security
